...
<nav id="column-left">
  ...
  <li id="dashboard"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span>Resume/Cover Letter</span></a>
    <ul>
     <li><a href="./account.php?id=<?php echo $id; ?>&route=<?php echo $_GET['route']; ?>">My Account</a></li >
...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>Edit</h3>
       <a href="./account.php?id=<?php echo $id; ?>"> <h3 class="panel-title" style="float:right"><i class="fa fa-list"></i>My Account</h3></a>
      </div>
      <div class="panel-body">
                <form action="./userdata/update.php" method="post" enctype="multipart/form-data" id="form-product">
                  <input type="hidden" value="<?php echo $id; ?>" name="id">
          <div class="table-responsive">
            <!-- image start -->
              <div class="image">
                <a>
                  <img src="http://localhost/az/admin/userdata/profilepic/<?php echo $email.'/'.$row12['image'];?>" alt="Acc" title="Profile Picture" class="img-responsive" style="width:200px;height:200px">
            ...
            <div>
              <div class="caption">
                <br><br>
                <h4>Name: <input type="text" name="name" value="<?php echo $row12['firstname'];?>" ></h4>
                <br>
                <h4>Email: <input type="text" name="email" value="<?php echo $row12['email'];?>"></h4>
                <br>
                <h4>Resume:  <?php echo $row12['resume'];?>  <input name="resume" type="file" class="updateresume" value="Update" > </h4><br>
                 <br>
                <h3>About:</h3>
                <p><texarea></textarea></p>
                 <textarea rows="10" name="about" cols="200"><?php echo $row12['about'];?></textarea>
               </div>
               </div>
            <!-- about end -->
            <input type="submit">
