<ul id="menu">
  ...
  <li id="dashboard"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo "Resume/Cover Letter"; ?></span></a>
    <ul>
      <?php $uname=$_SESSION['SESS_USER_NAME_AZ']; 
      $tokena=$_GET['token'];
      $uid=$_SESSION['SESS_USER_ID_AZ'];?> 

     <li><a href="account.php?route=<?php echo $tokena; ?> &user=<?php echo $uname; ?> &id=<?php echo $_SESSION['SESS_USER_ID_AZ']; ?>">My Account</a></li >
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $product; ?>"><?php 
      if($_SESSION['lang']=='en'){echo"Products:";}
                  elseif ($_SESSION['lang']=='ar') {echo " مبوب";}
      //echo $text_product; 
      ?></a></li>
