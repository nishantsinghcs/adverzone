<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-5"><a href="<?php echo $parent; ?>" style="display:none" data-toggle="tooltip" title="<?php echo $button_parent; ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>"  data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
          ...
          <button type="button" style="display:none" data-toggle="tooltip" title="<?php echo $button_folder; ?>" id="button-folder" class="btn btn-default"><i class="fa fa-folder"></i></button>
          <button type="button" style="display:none" data-toggle="tooltip" title="<?php echo $button_delete; ?>" id="button-delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
        </div>
         ...
         <div class="row">
      	 <div class="col-sm-3 text-center">
      	 	<div class="text-center">
      			...
      			<a href="" class="thumbnail"><img src="../image/catalog/<?php echo $_SESSION['imagename']; ?>" alt="" title="" /></a>
          <label>
            <input type="checkbox" name="path[]" value="./catalog/<?php echo $_SESSION['imagename']; ?>" />
            <?php echo $_SESSION['imagename']; ?></label>

            	<?php unset($_SESSION['imagename']) ;} ?>
        </div>
    </div>
  </div>
    ...
    <div class="modal-footer" style="display:none"><?php echo $pagination; ?></div>
  </div>
</div>
