...
mysql_select_db($DB_DATABASE, $conn) or die("I cannot  find the database.");
	...
	$mname = clean($_POST['companyname']);
	$lname = clean($_POST['contactname']);
	$email = clean($_POST['email']);
	$mobile = clean($_POST['mobile']);	
	$country = clean($_POST['address']);
	...
	//Create INSERT query
	$qry = "INSERT INTO az_user_adpost(fname,mname,lname,email,mobile,country,company,company_description,password,registered_on,registered_date) 
	VALUES('$fname','$mname','$lname','$email','$mobile','$country',1,'$description','$securedpass',1,NOW() )";
	$result = mysql_query($qry);
...
*/
	...
	//redirect to home page
		header("../loginadvertiser.php?newregistered=2");
		exit();
