...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$metatitletodesc=html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8');
			$metatitletodesc=str_replace("<p>", "", $metatitletodesc);
			$metatitletodesc=str_replace("</p>", "", $metatitletodesc);
			$this->document->setTitle($metatitletodesc);
			...
			// adding company/ user name
			$data['mpn'] = $product_info['mpn'];

			//adding jan for type knowing 
			$data['jan'] = $product_info['jan'];

			//adding upc for type knowing  KILOMETERS
			$data['upc'] = $product_info['upc'];

			//adding weight for type MAKE YEAR / min EXP / No. of bed rooms
			$data['weight'] = $product_info['weight'];

			//adding mata-title for education leve / owner- dealer / neighbourhoof info 
			$data['meta_title'] = $product_info['meta_title'];
			// tag for urgency 
			$data['tag']=$product_info['tag'];

			// tag for date
			$data['date']=strtotime($product_info['date_added']);
